...
# Last modified: 2024-08-20 15:10
...
nyc_grid_base.sf <- nyc_grid.sf <- st_intersection(nyc_grid.sf, NYC_ct.sf)
...
extracted_pop <- round(extract(NYC_rast_pop, nyc_grid.sf, fun='sum', na.rm = TRUE))
